...
class CrowdMesh extends THREE.InstancedMesh {
    ...
    init(
        ...
        if(crowd.instanceColorIn_All[this.meshType])//if(crowd.instanceColorIn_All[this.name])//
        ...
        if(this.meshTypeListElem.length<2){
            if(!crowdGroup.visible_instanceMatrix){
                crowdGroup.visible_instanceMatrix  =new THREE.InstancedBufferAttribute(new Float32Array(this.count*16), 16);
                crowdGroup.visible_textureType     = new THREE.InstancedBufferAttribute(new Uint8Array(this.count * 4), 4);
                crowdGroup.visible_animationType   = new THREE.InstancedBufferAttribute(new Uint8Array(this.count), 1);
                crowdGroup.visible_speed           = new THREE.InstancedBufferAttribute(new Float32Array(this.count), 1);
                crowdGroup.visible_obesity         = new THREE.InstancedBufferAttribute(new Float32Array(this.count), 1);
                crowdGroup.visible_moveMaxLength   = new THREE.InstancedBufferAttribute(new Float32Array(this.count), 1);
                crowdGroup.visible_animationStartTime = new THREE.InstancedBufferAttribute(new Float32Array(this.count), 1);
                crowdGroup.visible_bodyScale       = new THREE.InstancedBufferAttribute(new Float32Array(this.count * 4), 4);
            }
        ...
        if(this.instanceColorIn)
            this.instanceColorIn.origin=crowd.instanceColorIn_All[this.meshType]
