...
export class CrowdGroup extends THREE.Group {
    ...
    updateMap(pathPre,data){
        // console.log("crowd group updatemap",data)
        for(let meshName in data){
            ...
            // if(path&&this.children[meshName]){
            //     this.children[meshName].updateMap(path)

            // }
        }

    }
    init(groupOld,meshType,meshTypeList,cb_){
        var arr=[]
        ...
        this.createMeshAll(arr,meshType,meshTypeList,()=>{
            if(cb_)cb_()
        })
    ...
    createMeshAll(arr,meshType,meshTypeList,cb){
        var scope=this
        let indexFlag=0
        function next(i){
            var mesh=arr[i]
            ...
            if(meshType0==null){
                ...
                m2=>{
                    ...
                    // console.log(meshTypeList,meshType0)
