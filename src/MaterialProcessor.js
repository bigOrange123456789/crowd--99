...
class MaterialProcessor3{
	...
	async init(){
		...
		// this.normalMap=textureLoader.load("./assets/Char47/Ch23_1001_Normal.png")
		this.normalMap=await CrowdMaterial.getTexture_base64("./assets/Char47/Ch23_1001_Normal.png")
...
export { MaterialProcessor0,MaterialProcessor1,MaterialProcessor2,MaterialProcessor3 };