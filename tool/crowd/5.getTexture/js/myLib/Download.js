...
Download.prototype={
    ...
    materialDownload:function (material,name) {
        material.test1=1
        console.log(material.toJSON())
        let json0= material.toJSON() 
        
        // let json1=JSON.stringify(material)
        // let data=JSON.parse(json1)
        json0.map_ave_color=material.map_ave_color
        // let json2=JSON.stringify(data)
        console.log(json0)

        return this.strDownload(
            JSON.stringify(json0, null, 4),// JSON.stringify(json0),//
            name
        );
    },
