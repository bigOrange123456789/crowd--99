...
def getMeshLength(mesh):
    ...
    # print(l0,l1,l2,l3,np.array(img).reshape(-1).shape)
    # storeBin(path, data)
    return l0+l1+l2+l3

def saveMeshes(path,meshes):
    data=[]
    for mesh in meshes:
        getMeshLength(mesh)
        saveMesh(mesh,data)
...
def getMesh(value):
            ...
            return {
                ...
                "img2":array2,
                "img3":array3
                # "path":path#outpath+fileName+"/"+meshname+'.bin'
            }
